 ...
 *
 */
public class SortByARIfFrequencyIsSame {
	 ...
	 * @return myArrayList<logFile> the extracted arraylist based on sort if frequency is same
	 */
	public MyArrayList<LogFile> sortByAlphaSameFreq(MyArrayList<LogFile> str) {
		...
		for (int i = 0; i < str.getSize(); i++) {
			j = i + 1;
				...
				if ( (j <= str.getSize() - 1) && (((LogFile) str.get(i)).getFrequency() == ((LogFile) str.get(j)).getFrequency())) {
